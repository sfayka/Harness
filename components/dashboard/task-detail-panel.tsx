              ...
              <dl className="grid grid-cols-2 gap-x-4 gap-y-3 text-sm">
                <div>
                  ...
                  <dd className="flex items-center gap-1 mt-0.5">
                    ...
                    <span className="font-medium">{task.origin.source_system}</span>
                    <span className="text-muted-foreground">/ {task.origin.source_id}</span>
                  </dd>
                </div>
                <div>
              ...
              <CardContent>
                <dl className="space-y-2 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium">{task.assigned_executor.executor_type}</span>
                  ...
                  {task.relationships.parent_task_id && (
                    <div>
                      ...
                      <div className="flex items-center gap-1 mt-0.5">
                        ...
                        <span className="font-mono text-xs">{task.relationships.parent_task_id}</span>
                      </div>
                    </div>
                  )}
                  {task.relationships.child_task_ids.length > 0 && (
