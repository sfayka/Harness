...
def _demo_review_note_artifact() -> dict[str, Any]:
    return {
        ...
        "provenance": {
            ...
            "source_id": "review/openclaw-spike-note-1",
...
def run_openclaw_spike_flow(*, base_url: str, task_id: str = "task-openclaw-spike-1") -> OpenClawHarnessSpikeResult:
    ...
    reevaluation_status, reevaluation_payload = client.reevaluate_task(
        ...
        completion_evidence={
            ...
            "validator": {
                "source_system": "openclaw",
                "source_type": "integration_spike",
                "source_id": "openclaw-spike-completion-1",
                "captured_by": "openclaw-spike",
            },
            "notes": "The operator confirmation note arrived and OpenClaw resubmitted the completion attempt.",
        },
