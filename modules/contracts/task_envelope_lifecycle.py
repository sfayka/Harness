...
_ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    "intake_ready": {"planned", "blocked", "in_review"},
    "planned": {"dispatch_ready", "blocked", "in_review", "canceled"},
    "dispatch_ready": {"assigned", "blocked", "in_review", "canceled"},
    "assigned": {"executing", "blocked", "in_review", "failed", "canceled"},
