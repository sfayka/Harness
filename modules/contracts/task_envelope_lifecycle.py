...
_ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    "intake_ready": {"planned", "blocked", "in_review", "completed"},
    "planned": {"dispatch_ready", "blocked", "in_review", "completed", "canceled"},
    "dispatch_ready": {"assigned", "blocked", "in_review", "completed", "canceled"},
