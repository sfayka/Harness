...
_ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    "intake_ready": {"planned", "blocked", "in_review", "completed", "failed"},
    "planned": {"dispatch_ready", "blocked", "in_review", "completed", "failed", "canceled"},
    "dispatch_ready": {"assigned", "blocked", "in_review", "completed", "failed", "canceled"},
    "assigned": {"executing", "blocked", "in_review", "completed", "failed", "canceled"},
    "executing": {"completed", "blocked", "in_review", "failed", "canceled"},
    "blocked": {"intake_ready", "planned", "dispatch_ready", "assigned", "executing", "in_review", "completed", "failed", "canceled"},
