...
_ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    ...
    "planned": {"dispatch_ready", "reconciling", "blocked", "in_review", "completed", "failed", "canceled"},
    "dispatch_ready": {"assigned", "reconciling", "blocked", "in_review", "completed", "failed", "canceled"},
    "assigned": {"executing", "reconciling", "blocked", "in_review", "completed", "failed", "canceled"},
    "executing": {"reconciling", "completed", "blocked", "in_review", "failed", "canceled"},
    "reconciling": {"blocked", "in_review", "completed", "failed", "canceled"},
    "blocked": {"intake_ready", "planned", "dispatch_ready", "assigned", "executing", "reconciling", "in_review", "completed", "failed", "canceled"},
...
_AUTHORIZED_ACTORS: dict[tuple[str, str], set[str]] = {
    ...
    ("intake_ready", "reconciling"): {"reconciliation"},
    ("intake_ready", "blocked"): {"intake", "clarification", "verification"},
    ("intake_ready", "in_review"): {"verification"},
    ("intake_ready", "completed"): {"verification"},
    ("intake_ready", "failed"): {"verification"},
    ("planned", "dispatch_ready"): {"planner"},
    ("planned", "reconciling"): {"reconciliation"},
    ("planned", "blocked"): {"planner", "verification"},
    ("planned", "in_review"): {"verification"},
    ("planned", "completed"): {"verification"},
    ("planned", "failed"): {"verification"},
    ("planned", "canceled"): {"operator", "manual_review"},
    ("dispatch_ready", "assigned"): {"dispatcher"},
    ("dispatch_ready", "reconciling"): {"reconciliation"},
    ("dispatch_ready", "blocked"): {"dispatcher", "operator", "manual_review", "verification"},
    ("dispatch_ready", "in_review"): {"verification"},
    ("dispatch_ready", "completed"): {"verification"},
    ("dispatch_ready", "failed"): {"verification"},
    ("dispatch_ready", "canceled"): {"operator", "manual_review"},
    ("assigned", "executing"): {"runtime"},
    ("assigned", "reconciling"): {"reconciliation"},
    ("assigned", "blocked"): {"dispatcher", "runtime", "operator", "manual_review"},
    ("assigned", "in_review"): {"verification"},
    ("assigned", "completed"): {"verification"},
    ("assigned", "failed"): {"runtime", "verification"},
    ("assigned", "canceled"): {"operator", "manual_review"},
    ("executing", "reconciling"): {"reconciliation"},
    ...
    ("blocked", "failed"): {"verification", "manual_review"},
