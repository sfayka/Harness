"""Executable runtime scenario fixtures for the full HTTP evaluation path.

These builders are intentionally separate from:

- `examples/api/` synced contract examples
- `modules/demo_cases.py` demo-oriented control-plane requests

They describe live-runnable API scenarios for the local test runtime.
"""
