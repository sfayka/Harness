...
class HarnessApiServiceTests(unittest.TestCase):
    ...
    def test_service_manual_ingress_converts_unresolved_conditions_into_clarification_block(self) -> None:
        ...
        self.assertFalse(payload["execution_continuation"]["attempted"])
        self.assertFalse(payload["execution_continuation"]["dispatchable"])
        self.assertEqual(payload["execution_continuation"]["surface"], "legacy_direct_dispatch")
        self.assertTrue(payload["execution_continuation"]["compatibility_mode"])
        self.assertEqual(payload["execution_continuation"]["preferred_execution_surface"], "execution_substrate")
        self.assertEqual(payload["execution_continuation"]["execution_transport_status"], "disabled")
        self.assertFalse(payload["execution_continuation"]["live_dispatch_enabled"])
        self.assertEqual(payload["execution_continuation"]["completion_authority"], "harness_verification")
        self.assertFalse(payload["execution_continuation"]["runner_completion_is_truth"])
    ...
    def test_service_dispatch_task_records_attempt_and_runs_reevaluation(self) -> None:
        ...
        self.assertEqual(dispatch_response["dispatch"]["execution_transport_status"], "disabled")
        self.assertFalse(dispatch_response["dispatch"]["live_dispatch_enabled"])
        self.assertEqual(dispatch_response["dispatch"]["completion_authority"], "harness_verification")
        self.assertFalse(dispatch_response["dispatch"]["runner_completion_is_truth"])
        self.assertEqual(
        ...
        self.assertEqual(latest_attempt["metadata"]["execution_transport_status"], "disabled")
        self.assertFalse(latest_attempt["metadata"]["live_dispatch_enabled"])
        self.assertEqual(latest_attempt["metadata"]["completion_authority"], "harness_verification")
        self.assertFalse(latest_attempt["metadata"]["runner_completion_is_truth"])
        self.assertEqual(timeline_status, 200)
    ...
    def test_service_submit_auto_dispatches_dispatch_ready_task(self) -> None:
        ...
        self.assertEqual(submit_status, 200)
        self.assertTrue(submit_response["execution_continuation"]["attempted"])
        self.assertEqual(submit_response["execution_continuation"]["status"], 200)
        self.assertEqual(submit_response["execution_continuation"]["dispatch"]["attempt_id"], "attempt-1")
        self.assertEqual(submit_response["execution_continuation"]["surface"], "legacy_direct_dispatch")
        self.assertTrue(submit_response["execution_continuation"]["compatibility_mode"])
        self.assertEqual(submit_response["execution_continuation"]["preferred_execution_surface"], "execution_substrate")
        self.assertEqual(submit_response["execution_continuation"]["execution_transport_status"], "disabled")
        self.assertFalse(submit_response["execution_continuation"]["live_dispatch_enabled"])
        self.assertEqual(submit_response["execution_continuation"]["completion_authority"], "harness_verification")
        self.assertFalse(submit_response["execution_continuation"]["runner_completion_is_truth"])
    ...
    def test_service_submit_does_not_auto_dispatch_planned_task(self) -> None:
        ...
        self.assertEqual(submit_status, 200)
        self.assertFalse(submit_response["execution_continuation"]["attempted"])
        self.assertFalse(submit_response["execution_continuation"]["dispatchable"])
        self.assertEqual(submit_response["execution_continuation"]["surface"], "legacy_direct_dispatch")
        self.assertTrue(submit_response["execution_continuation"]["compatibility_mode"])
        self.assertEqual(submit_response["execution_continuation"]["execution_transport_status"], "disabled")
        self.assertFalse(submit_response["execution_continuation"]["live_dispatch_enabled"])
