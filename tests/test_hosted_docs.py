...
class HostedDocsTests(unittest.TestCase):
    def test_agent_instruction_entrypoints_exist_and_name_proofline_boundary(self) -> None:
        ...
        proofline_skill_path = Path("skills/proofline-acceptance/SKILL.md")
        hermes_skill_path = Path("skills/hermes-proofline/SKILL.md")
        agents = agents_path.read_text(encoding="utf-8")
        claude = claude_path.read_text(encoding="utf-8")
        proofline_skill = proofline_skill_path.read_text(encoding="utf-8")
        hermes_skill = hermes_skill_path.read_text(encoding="utf-8")

        self.assertTrue(agents_path.exists())
        self.assertTrue(claude_path.exists())
        self.assertTrue(proofline_skill_path.exists())
