...
| Runtime/process env vars | `HARNESS_RUNTIME_*`, `HARNESS_DASHBOARD_ASSETS_DIR` | rename-later | Keep old env vars valid. Add Proofline aliases only after local-runtime process precedence and packaged-dashboard behavior are documented and tested. |
