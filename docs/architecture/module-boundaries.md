...
| Intake and normalization | Harness core | convert validated requests into canonical Harness work objects, reject malformed inputs, attach metadata needed for planning and verification | UI policy, executor-specific logic |
